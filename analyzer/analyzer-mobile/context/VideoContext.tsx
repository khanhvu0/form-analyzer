...
// Extended moment interface with all possible fields
interface KeyMoment {
  frame: number;
  timestamp: number;
  label: string;
  ...
  right_shoulder_position?: Position;
  right_elbow_position?: Position;
  left_shoulder_position?: Position;
  ...
  const processVideos = async () => {
    ...
    try {
      ...
      if (response.status === 'success') {
        ...
        const firstProcessedVideo = processedVideos.find(v => v.label === 'First Video');
        const secondProcessedVideo = processedVideos.find(v => v.label === 'Second Video');
